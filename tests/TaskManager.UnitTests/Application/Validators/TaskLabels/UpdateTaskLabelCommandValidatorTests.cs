...
public class UpdateTaskLabelCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new UpdateTaskLabelCommand(1, "Work", LabelColor.Blue);
    ...
    {
        // Arrange
        var command = new UpdateTaskLabelCommand(1, name, LabelColor.Blue);
    ...
    public void Validate_WithLongName_ShouldBeInvalid()
    {
        ...
        var command = new UpdateTaskLabelCommand(1, longName, LabelColor.Blue);
    ...
    {
        // Arrange
        var command = new UpdateTaskLabelCommand(1, "AB", LabelColor.Blue);
    ...
    public void Validate_WithMaximumValidName_ShouldBeValid()
    {
        ...
        var command = new UpdateTaskLabelCommand(1, maxName, LabelColor.Blue);
    ...
    {
        // Arrange
        var command = new UpdateTaskLabelCommand(1, "Valid Name", (LabelColor)999);
    ...
    {
        // Arrange
        var command = new UpdateTaskLabelCommand(1, "Work", color);
