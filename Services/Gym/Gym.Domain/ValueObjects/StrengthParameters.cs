...
{
    public class StrengthParameters : ValueObject
    {
        ...
        protected StrengthParameters() { }

        public StrengthParameters(int sets, int repetitions, Weight weight = null, Duration restTime = null)
        {
            if (sets <= 0)
