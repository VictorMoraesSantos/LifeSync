...
namespace Nutrition.Domain.Errors
{
    ...
    {
        // Erros de validação
        public static Error InvalidName => Error.Failure("O nome do líquido é obrigatório");
        public static Error EmptyName => Error.Failure("O nome do líquido não pode estar vazio");
        ...
        public static Error UpdateError => Error.Problem("Erro ao atualizar líquido");
        public static Error DeleteError => Error.Problem("Erro ao excluir líquido");
        ...
        public static Error ExcessiveQuantity => Error.Failure("Quantidade de líquido excede o limite permitido");
        public static Error InvalidCaloriesRange => Error.Failure("Calorias por ml devem estar dentro do intervalo válido");
        // Erros de parâmetros
