        ...
        public async Task<Result<(IEnumerable<DailyProgressDTO> Items, PaginationData Pagination)>> GetByFilterAsync(DailyProgressQueryFilterDTO filter, CancellationToken cancellationToken)
        {
            try
            {
                var domainFilter = new DailyProgressQueryFilter(
                    ...
                    filter.UserId,
                    filter.Date,
                    filter.CaloriesConsumedEquals,
                    filter.CaloriesConsumedGreaterThan,
                    filter.CaloriesConsumedLessThan,
                    filter.LiquidsConsumedMlEquals,
                    filter.LiquidsConsumedMlGreaterThan,
                    filter.LiquidsConsumedMlLessThan,
                    filter.CreatedAt,
                    filter.UpdatedAt,
                    filter.IsDeleted,
                    filter.SortBy,
