...
namespace Financial.Infrastructure.Migrations
{
    ...
    [Migration("20250530011316_initialcreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Financial.Domain.Entities.FinancialAccount", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Balance", "Financial.Domain.Entities.FinancialAccount.Balance#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Financial.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Amount", "Financial.Domain.Entities.Transaction.Amount#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("FinancialControl.Domain.ValueObjects.Money", b =>
                {
                    b.ToTable("Money");
                });
